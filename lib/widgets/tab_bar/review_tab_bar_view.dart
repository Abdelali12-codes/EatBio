import 'package:eatbio_project/models/review_model.dart';
import 'package:eatbio_project/models/darna_model.dart';
import 'package:eatbio_project/screens/review_screen.dart';
import 'package:eatbio_project/utils/colors.dart';
import 'package:eatbio_project/utils/toast.dart';
import 'package:eatbio_project/widgets/review_card_widget.dart';
...
class ReviewTabBarView extends StatefulWidget {
  ...
  @override
  _ReviewTabBarViewState createState() => _ReviewTabBarViewState();
}
          ...
          child: Row(
            children: [
              Container(
                ...
                child: CircleAvatar(
                  backgroundImage: AssetImage('assets/avatars/abdelali.jpg'),
                ),
              ),
              SizedBox(width: 12.0),
              Expanded(
