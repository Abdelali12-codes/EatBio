...
import 'package:eatbio_project/widgets/cooker_tabbar/cooker_basic_info.dart';
import 'package:eatbio_project/widgets/cooker_tabbar/cooker_review_tab_bar.dart';
import 'package:eatbio_project/widgets/cooker_tabbar/portfolio_tab_bar_view.dart';
...
class CookerPage extends StatefulWidget {
  final CookerModel barber;
  final DarnaModel salon;

  const CookerPage({Key key, @required this.salon, this.barber})
      : super(key: key);

  @override
  _CookerPageState createState() => _CookerPageState();
}

class _CookerPageState extends State<CookerPage> with TickerProviderStateMixin {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Center(
              child: [
                CookerBasicInfoTabBarView(barber: widget.barber),
                PortfolioTabBarView(),
                CookerTabBarView(),
